# Editing existing Cadence documentation
...
Check commands against the scripts in `package.json`. Check API examples against each package's public exports, stories and tests. Check clinical statements against the cited source, never against memory.
