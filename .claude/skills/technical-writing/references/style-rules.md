# Cadence documentation style

## Names and capitalization

- Write "Cadence" for the design system and "Cadence Clinical" for the project and website.
- Match public API, CLI, provider, and product names exactly.
- Use sentence case for headings.
- Use Australian English (colour, licence as a noun, organisation). Do not use the Oxford comma unless a list is ambiguous without it.
