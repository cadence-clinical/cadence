...
| [0015](0015-charts.md)                  | Cadence draws its charts in SVG, on d3-scale                                       | Accepted                              |
| [0016](0016-fhir-transforms.md)         | FHIR transforms are written by hand, and a schema interprets outside the component | Accepted                              |
