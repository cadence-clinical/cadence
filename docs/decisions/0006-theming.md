...
Updated 2026-09-22: a touch device that has not set a density gets a touch default between compact and comfortable, with 40px controls, 14px text and 12px padding. It had been comfortable, with 44px controls and 15px text, which the maintainer found too loose on a phone. Comfortable is unchanged and still gives 44px targets to anyone who sets it. A large control is 44px at the touch default.
